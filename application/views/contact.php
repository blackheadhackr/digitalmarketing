                ...
                <div class="container">
                    <div class="row mt-5 mb-5">
                        ...
                        <ul class="contact__location">
                            ...
                            <li class="text__lowercase"><h3>Contact</h3><span> <a href="mailto:">auxa@example.com</a> , <a href="tel:+">+1 800 123 456 789</a></span></li>
                            <li><h3>Social</h3><span><a href="#">Instagram</a> <a href="#">Behance</a> <a href="#">Dribbble</a>  <a href="#">Facebook</a> <a href="#">Twitter</a></span></li>
                        </ul>
                    </div>
                ...
                success:function(data){
                    if(data.result == "error"){
                        if(data.name != ""){
                            ...
                            $("#fullname").css({"border-bottom": "1px solid rgba(255, 255, 255, .18)"});
                        }
                        if(data.email != ""){
                            $("#Email").css({"border-bottom": "1px solid red"});
                        }else{
                            $("#Email").css({"border-bottom": "1px solid rgba(255, 255, 255, .18)"});
                        }
                        if(data.number != ""){
                            $("#Contact").css({"border-bottom": "1px solid red"});
                        }else{
                            $("#Contact").css({"border-bottom": "1px solid rgba(255, 255, 255, .18)"});
                        }
                        if(data.service != ""){
                            $("#Company").css({"border-bottom": "1px solid red"});
                        }else{
                            $("#Company").css({"border-bottom": "1px solid rgba(255, 255, 255, .18)"});
                        }
                        if(data.message != ""){
                            $("#message").css({"border-bottom": "1px solid red"});
                        }else{
                            $("#message").css({"border-bottom": "1px solid rgba(255, 255, 255, .18)"});
                        }
                    }else{
                        Swal.fire({
                            position: "top-end",
                        ...
                        $(".item__field").css({"border-bottom": "1px solid rgba(255, 255, 255, .18)"});
                        $('#cont_form')[0].reset();
                    }
                }
            })
